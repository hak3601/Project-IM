...
# --- Updated MediaPipe FaceMesh landmark indices based on requested regions ---
# Note: The indices are approximations based on the nearest landmarks matching the description.

# Forehead: should be above the eyebrows (using points along the hairline/upper head)
# Original points were near the top of the face/eyebrow area.
FOREHEAD_IDXS = [
    10, 338, 297, 336, 150, 263, 249, 390, 373, 
    46, 105, 107, 66, 67, 108, 109, 10, 338, 297, 336
]

# Cheeks: starts under the eyes and end above the lip
# The original indices are a good basis but the new requirement is stricter.
# We'll use points under the eyes and above the mouth/lip area.
# Left Cheek: Under left eye, above left corner of lip.
LEFT_CHEEK_IDXS = [
    234, 132, 137, 169, 210, 199, 126, 93, 
    58, 172, 136, 149, 150, 176 # including some outer jaw/mid-face points for width
]

# Right Cheek: Under right eye, above right corner of lip.
RIGHT_CHEEK_IDXS = [
    454, 361, 366, 396, 430, 419, 355, 323, 
    288, 397, 365, 378, 379, 400 # including some outer jaw/mid-face points for width
]

# Chin: from the under of lip (points on the lower lip border and central chin/jawline)
CHIN_IDXS = [
    152,        # chin center
    150, 149, 176, 148, # lower left jaw/chin points
    377, 400, 378, 379, 365, # lower right jaw/chin points
    17, 84, 91, 181, 405, 314 # points around the lower lip/mouth center
]
...
def process_image(path, face_mesh):
    ...
    # Chin
    cx1, cy1, cx2, cy2 = get_bbox(pts, CHIN_IDXS, w, h, PADDING)
    chin = img[cy1:cy2, cx1:cx2]
...
if __name__ == "__main__":
    main()
    # The original script had a misplaced print statement here, removed/corrected for logic.