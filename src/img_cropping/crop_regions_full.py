...
# New: chin / lower jaw region (indices around chin center + lower jawline)
CHIN_IDXS = [
    152,        # chin center
    176, 148, 149, 150,     # lower left jaw
    400, 379, 378, 365      # lower right jaw
]
...
if __name__ == "__main__":
    main()
    print("[ERROR] no face landmarks in: {path}")